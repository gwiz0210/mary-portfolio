...
description: TerraChain is a startup and platform driving transparency, efficiency, and cost savings for commercial real estate owners by removing many of the existing inefficiencies in key processes.
image: ./image.jpg
banner: ./banner.jpg
---
...
- Real-time insights to data to increase transparency and inform better investment decisions and portfolio management
...
###### Property Insights
Based on continous iterations inspired by customer feedback, I created a portal to give portfolio managers access to real-time occupancy data and statistics for each of their building tenants.
<Row>
<Col>
...
###### Lease Creation
Portfolio managers can create an interactive lease in the portal. If they had existing leases in other platforms or paper leases, they can upload them into our software. 
<Row>
<Col>
...
Operating expenses customarily include repairs to the building including core building systems such the HVAC, elevators and sprinkler system. Often tenants just recieve a bill periodicaly. Terrachain's interactive lease  benefits both tenants and portfolio managers by providing them with real-time insights to expenses as they come up.
<Row>
<Col>
