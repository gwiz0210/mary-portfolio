...
const siteMetadata = {
    ...
    twoColumnWall: false, // If true, the wall will be split into two with titleImage on left side and text on the right. If false, the title image will be used as the background of the text.
    ...
    switchTheme: false, // Whether to show a switch theme button on the navbar
